...
class NewModel_1ss(object):
  def __init__(self):
    ...
    ex_mid1 = tf.sigmoid(tf.matmul(squeeze_flat1, W_ex11) + b_ex11)
    ...
    # second convolutional layer
    h_pool1 = self._max_pool_2x2(tf.nn.relu(se_out1))
    ...
    ex_mid2 = tf.sigmoid(tf.matmul(squeeze_flat2, W_ex21) + b_ex21)
    ...
    # first fully connected layer
    h_pool2 = self._max_pool_2x2(tf.nn.relu(se_out2))
...
class NewModel_1ts(object):
  def __init__(self):
    ...
    ex_mid1 = tf.nn.tanh(tf.matmul(squeeze_flat1, W_ex11) + b_ex11)
    ...
    ex_mid2 = tf.nn.tanh(tf.matmul(squeeze_flat2, W_ex21) + b_ex21)
...
class NewModel_2ss(object):
  def __init__(self):
    ...
    ex_scale1 = tf.sigmoid(tf.matmul(ex_mid1, W_ex12) + b_ex12)
    ex_scale1 = tf.reshape(ex_scale1, [-1, 1, 1, 32])
    se_out1 = ex_scale1 * tf.nn.relu(h_conv1)
    ...
    ex_scale2 = tf.sigmoid(tf.matmul(ex_mid2, W_ex22) + b_ex22)
    ex_scale2 = tf.reshape(ex_scale2, [-1, 1, 1, 64])
    se_out2 = ex_scale2 * tf.nn.relu(h_conv2)
